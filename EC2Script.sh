...
sudo sed -i 's,/var/www/html/FrontendWebsite/target/dist/FrontendWebsite/target/dist,/var/www/html/FrontendWebsite/target/dist,g' /etc/nginx/sites-available/default
